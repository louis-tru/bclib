...
export class ErrnoList extends SysErrnoList {
	...
	ERR_ETH_TRANSACTION_DISCARD: ErrnoCode = [100272, 'ERR_ETH_TRANSACTION_DISCARD']
	ERR_ETH_CONTRACT_METHOD_NO_EXIST: ErrnoCode = [100273, 'ERR_ETH_CONTRACT_METHOD_NO_EXIST']
	ERR_ETH_CONTRACT_METHOD_ARGS_ERR: ErrnoCode = [100274, 'ERR_ETH_CONTRACT_METHOD_ARGS_ERR']
}
