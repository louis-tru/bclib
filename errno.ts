...
export class ErrnoList extends SysErrnoList {
	...
	ERR_QINIU_UPLOAD_ERR: ErrnoCode = [100300, 'ERR_QINIU_UPLOAD_ERR']
	ERR_NO_QINIU_CONFIG: ErrnoCode = [100301, 'ERR_NO_QINIU_CONFIG']
	ERR_REPEAT_LOAD_SQLITE: ErrnoCode = [100302, 'ERR_REPEAT_LOAD_SQLITE']
	ERR_QINIU_STATE_FILE_404: ErrnoCode = [100303, 'ERR_QINIU_STATE_FILE_404']
	ERR_QINIU_RESULT_ERROR: ErrnoCode = [100304, 'ERR_QINIU_RESULT_ERROR']
	ERR_ETH_TRANSACTION_DISCARD: ErrnoCode = [100305, 'ERR_ETH_TRANSACTION_DISCARD']
	ERR_ETH_CONTRACT_METHOD_NO_EXIST: ErrnoCode = [100306, 'ERR_ETH_CONTRACT_METHOD_NO_EXIST']
	ERR_ETH_CONTRACT_METHOD_ARGS_ERR: ErrnoCode = [100307, 'ERR_ETH_CONTRACT_METHOD_ARGS_ERR']
}
