...
export class ErrnoList extends SysErrnoList {
	...
	ERR_QINIU_STATE_FILE_404: ErrnoCode = [110003, 'ERR_QINIU_STATE_FILE_404']
	ERR_QINIU_RESULT_ERROR: ErrnoCode = [110004, 'ERR_QINIU_RESULT_ERROR']
	ERR_ETH_TRANSACTION_DISCARD: ErrnoCode = [110005, 'ERR_ETH_TRANSACTION_DISCARD']
	ERR_ETH_CONTRACT_METHOD_NO_EXIST: ErrnoCode = [110006, 'ERR_ETH_CONTRACT_METHOD_NO_EXIST']
	ERR_ETH_CONTRACT_METHOD_ARGS_ERR: ErrnoCode = [110007, 'ERR_ETH_CONTRACT_METHOD_ARGS_ERR']
	ERR_ZSW_PUBLIC_KEY_INVALID: ErrnoCode = [110007, 'ERR_ZSW_PUBLIC_KEY_INVALID']
	ERR_ONLY_SUPPORT_K1_PUBLIC_KEY: ErrnoCode = [110008, 'ERR_ONLY_SUPPORT_K1_PUBLIC_KEY']
	ERR_ZSW_FROM_ACCOUNT_NOT_EXIST: ErrnoCode = [110009, 'ERR_ZSW_FROM_ACCOUNT_NOT_EXIST']
	ERR_ZSW_POST_TRANSACTIONS_FAIL: ErrnoCode = [110010, 'ERR_ZSW_POST_TRANSACTIONS_FAIL']
	ERR_ZSW_POST_TRANSACTIONS_TIMEOUT: ErrnoCode = [110011, 'ERR_ZSW_POST_TRANSACTIONS_TIMEOUT']
	...
	ERR_S3_UPLOAD_ERR: ErrnoCode = [110015, 'ERR_S3_UPLOAD_ERR']
	// Tasks
